...
from parsec.commands.workflows.extract_workflow_from_history import cli as extract_workflow_from_history
...
from parsec.commands.workflows.show_versions import cli as show_versions
...
cli.add_command(extract_workflow_from_history)
