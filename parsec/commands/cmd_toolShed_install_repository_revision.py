...
@bioblend_exception
@dict_output
def cli(ctx, tool_shed_url, name, owner, changeset_revision, install_tool_dependencies=False, install_repository_dependencies=False, tool_panel_section_id="", new_tool_panel_section_label=""):
