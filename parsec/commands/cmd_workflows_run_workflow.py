...
def cli(ctx, galaxy_instance, workflow_id, dataset_map, params, history_id, history_name, replacement_params, import_inputs_to_history=False):
    ...
    """
    return ctx.gi.workflows.run_workflow(workflow_id, dataset_map, params, history_id, history_name, replacement_params, import_inputs_to_history=import_inputs_to_history)
